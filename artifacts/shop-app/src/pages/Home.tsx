...
export default function Home() {
  ...
  return (
    <div className="pb-2">
      {/* Header */}
      <div className="bg-gradient-to-br from-primary to-orange-400 text-primary-foreground px-5 pt-12 pb-8 rounded-b-[2.5rem]">
        <p className="text-sm font-medium opacity-80 mb-1">नमस्ते!</p>
        <h1 className="text-2xl font-bold mb-1">अपना Bazaar</h1>
        <p className="text-sm opacity-80">सब कुछ एक जगह मिलेगा</p>
        ...
        {search.length > 0 && (
          <div>
            ...
            {filteredProducts.length === 0 && filteredServices.length === 0 ? (
              <p className="text-muted-foreground text-sm text-center py-4">कोई result नहीं मिला</p>
            ) : (
              <>
        ...
        {!search && (
          <div>
            <div className="grid grid-cols-3 gap-3">
              {[
                { label: "नाई", sub: "Barber", path: "/barber", bg: "bg-orange-50 border-orange-200", icon: "✂️" },
                { label: "सब्जी-फल", sub: "Veggies", path: "/sabji", bg: "bg-green-50 border-green-200", icon: "🥦" },
                { label: "राशन", sub: "Grocery", path: "/grocery", bg: "bg-amber-50 border-amber-200", icon: "🛒" },
                { label: "प्लंबर", sub: "Plumber", path: "/other", bg: "bg-blue-50 border-blue-200", icon: "🔧" },
                { label: "टिफिन", sub: "Tiffin", path: "/other", bg: "bg-rose-50 border-rose-200", icon: "🍱" },
                { label: "बुकिंग", sub: "Booking", path: "/booking", bg: "bg-purple-50 border-purple-200", icon: "📅" },
              ].map((cat) => (
                <button
